...
export const ParentModule: React.FC = () => {
  ...
  useEffect(() => {
    ...
    parentApi.initChatRoom('t-1001', 'p-9001', 't-7001').then((res: any) => {
  ...
  const handleToggleAbsence = async () => {
    ...
    try {
      await parentApi.flagAbsence('t-1001', 'r-sabah-1', 'n2', 's-8001',
  ...
  const handleSendMessage = useCallback(async (text?: string) => {
    ...
    try {
      await parentApi.sendMessage(roomId, msg, 'p-9001');
