...
export class RadarApiService {
  static async getVehiclePositions(tenantId: string): Promise<VehiclePosition[]> {
    try {
      ...
      await delay(300);
      return [
        { id: 'v1', plate: '34 AB 1234', route: 'Kavacık - Sabah', x: 35, y: 40, lat: 41.0921, lng: 29.0945, speed: 42, driver: 'Mehmet Şahin', status: 'ON_ROUTE' },
        { id: 'v2', plate: '34 CD 5678', route: 'Anaokulu Öğlen', x: 65, y: 55, lat: 41.0988, lng: 29.1012, speed: 28, driver: 'Ali Yılmaz', status: 'WARNING' },
        { id: 'v3', plate: '34 EF 9012', route: 'Akşam Fabrika', x: 50, y: 70, lat: 41.0860, lng: 29.0830, speed: 0, driver: 'Hasan Kaya', status: 'STANDBY' },
        { id: 'v4', plate: '34 GH 3456', route: 'Etüt Seferi', x: 20, y: 30, lat: 41.0890, lng: 29.0650, speed: 55, driver: 'Burak Demir', status: 'ON_ROUTE' },
      ];
    }
  }
